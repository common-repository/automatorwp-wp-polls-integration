...
Tags: polls, automatorwp, poll, vote, polling
...
Connect AutomatorWP with WP Polls
...
[WP Polls](https://wordpress.org/plugins/wp-polls/ "WP Polls") adds a powerful polls system to your WordPress letting your users vote anything of any poll on your website.

This plugin automatically connects [AutomatorWP](https://wordpress.org/plugins/automatorwp/ "AutomatorWP") with WP Polls adding new triggers that you can use to connect with other plugins and automate workflows letting you save time and get focused on your most important work.

= Triggers =

* User votes on any/specific poll.
